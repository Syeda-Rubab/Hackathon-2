...
function Footer() {
    return(
        <>
        <section className="w-full h-[300px] pt-16 pl-5 border-t-2 hidden md:hidden lg:flex xl:flex">
            ...
            <div className="w-[350px]">
                <h2 className="text-[16px] text-gray-400">Links</h2>
                <ul className="mt-10">
            ...
            <div className="w-[350px]">
                <h2 className="text-[16px] text-gray-400">Help</h2>
                <ul className="mt-10">
            ...
            <div className="w-[350px]">
                <h2 className="text-[16px] text-gray-400">Newslatter</h2>
        ...
        <div className="w-full h-[66px] border-t-2 border-gray-200 flex items-center px-5">
            <h2>2023 Furino, All rights reserved</h2>
        </div>
        </>
    );
};
